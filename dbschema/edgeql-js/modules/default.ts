...
export type $AdministratorλShape = $.typeutil.flatten<_std.$Object_8ce8c71ee4fa5f73840c22d7eaa58588λShape & {
...
export type $AgreementλShape = $.typeutil.flatten<_std.$Object_8ce8c71ee4fa5f73840c22d7eaa58588λShape & {
  ...
  "versions": $.LinkDesc<$AgreementVersion, $.Cardinality.Many, {}, true, false,  false, false>;
...
type $Agreement = $.ObjectType<"default::Agreement", $AgreementλShape, null, [
  ..._std.$Object_8ce8c71ee4fa5f73840c22d7eaa58588['__exclusives__'],
  {versions: {__element__: $AgreementVersion, __cardinality__: $.Cardinality.One | $.Cardinality.AtMostOne },},
...
export type $AgreementTextλShape = $.typeutil.flatten<_std.$Object_8ce8c71ee4fa5f73840c22d7eaa58588λShape & {
  "creation_time": $.PropertyDesc<_std.$datetime, $.Cardinality.One, false, false, false, true>;
  ...
  "update_time": $.PropertyDesc<_std.$datetime, $.Cardinality.One, false, false, false, true>;
  "<texts[is AgreementVersion]": $.LinkDesc<$AgreementVersion, $.Cardinality.AtMostOne, {}, false, false,  false, false>;
...
export type $AgreementVersionλShape = $.typeutil.flatten<_std.$Object_8ce8c71ee4fa5f73840c22d7eaa58588λShape & {
  "creation_time": $.PropertyDesc<_std.$datetime, $.Cardinality.One, false, false, false, true>;
  ...
  "texts": $.LinkDesc<$AgreementText, $.Cardinality.Many, {}, true, false,  false, false>;
  ...
  "<versions[is Agreement]": $.LinkDesc<$Agreement, $.Cardinality.AtMostOne, {}, false, false,  false, false>;
...
type $AgreementVersion = $.ObjectType<"default::AgreementVersion", $AgreementVersionλShape, null, [
  ..._std.$Object_8ce8c71ee4fa5f73840c22d7eaa58588['__exclusives__'],
  {texts: {__element__: $AgreementText, __cardinality__: $.Cardinality.One | $.Cardinality.AtMostOne },},
], "default::AgreementVersion">;
...
export type $CommentInfoλShape = $.typeutil.flatten<_std.$Object_8ce8c71ee4fa5f73840c22d7eaa58588λShape & {
...
export type $ContributorLicenseAgreementλShape = $.typeutil.flatten<_std.$Object_8ce8c71ee4fa5f73840c22d7eaa58588λShape & {
...
type $ContributorLicenseAgreement = $.ObjectType<"default::ContributorLicenseAgreement", $ContributorLicenseAgreementλShape, null, [
  ..._std.$Object_8ce8c71ee4fa5f73840c22d7eaa58588['__exclusives__'],
  {email: {__element__: _std.$str, __cardinality__: $.Cardinality.One | $.Cardinality.AtMostOne },},
], "default::ContributorLicenseAgreement">;
...
export type $RepositoryλShape = $.typeutil.flatten<_std.$Object_8ce8c71ee4fa5f73840c22d7eaa58588λShape & {
